...
def lamaml_scifar100(override_args=None):
    ...
    # Loggers and metrics
    csv_logger = avl.logging.CSVLogger('../results/csv/lamaml_scifar100_KAN')
    tensorboard_logger = avl.logging.TensorboardLogger('../results/tensorboard/lamaml_scifar100_KAN')
